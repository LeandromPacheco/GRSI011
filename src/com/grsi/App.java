...
public class App extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Esalada = new javax.swing.JButton();
        ...
        caixa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Vinagre Branco", "Vinagre Tinto" }));
        ...
        quantidade.setModel(new javax.swing.SpinnerNumberModel(1, 1, 276447231, 1));
        ...
        Esalada.setText("Encomendar salada");
        Esalada.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EsaladaActionPerformed(evt);
            }
        });
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(Esalada, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(reset, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(loja, javax.swing.GroupLayout.Alignment.TRAILING))))
                .addContainerGap())
        );
    ...
    private void lojaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lojaActionPerformed
        ...
        if (loja.isSelected()) {
            ...
            res.setEnabled(true);
            Esalada.setEnabled(true);
            reset.setEnabled(true);
        }

    }//GEN-LAST:event_lojaActionPerformed

    private void EsaladaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EsaladaActionPerformed
        // TODO add your handling code here:   
        res.setText("A sua salada irá conter:");
        ...
        if (fria.isSelected()) {
            res.setText(res.getText() + "\n" + "A tua sala será -> Fria");
        }
        if (natural.isSelected()) {
            res.setText(res.getText() + "\n" + "A tua sala será -> Natural");
        }
        res.setText(res.getText() + "\n" + "O vinagre será: ");
        if (caixa.getSelectedItem().toString() != null) {
            res.setText(res.getText() + "\n" + "- " + caixa.getItemAt(caixa.getSelectedIndex()));
        }
        res.setText(res.getText() + "\n" + "Quantidade de saladas: ");
        res.setText(res.getText() + "\n" + (quantidade.getValue()));
        res.setText(res.getText() + "\n" + "O tamanho da salada será: ");
        res.setText(res.getText() + "\n" + (slider.getValue()));
        res.setText(res.getText() + "\n" + "Ingredientes: ");
        res.append(lista.getSelectedValuesList() + "\n" + " ");
    ...
    }//GEN-LAST:event_EsaladaActionPerformed
    ...
    private javax.swing.JButton Esalada;
